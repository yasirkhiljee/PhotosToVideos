...
public interface GLESCanvas {
    ...
    /**
     * 在调用{@link com.purple.myapplication.filter.MovieFilter}绘制时先调用该函数释放自身的buffer，不然不知道绘到哪儿去了
     */
    public abstract void unbindArrayBuffer();
    /**
     * 在调用{@link com.purple.myapplication.filter.MovieFilter}绘制后调用该函数重新绑定自身的buffer，不然自己不知道绘到哪儿去了
     */
