package com.purple.myapplication.record;
    ...
    public void startRecordImpl(final OnRecordListener listener) throws IOException {
        ...
        try {
            while (true) {
                ...
                MLog.i(TAG, "com.purple.myapplication.record frame " + frameCount);
                MLog.i(TAG, "com.purple.myapplication.record 耗时 " + (e - s) + "ms" + " 绘制耗时:" + (e1 - s1) + "ms");
                frameCount++;
                elapsedTime += frameTime;
                /**
                 * 有的PhotoMovie时长是会变化的{@link com.purple.myapplication.segment.MovieSegment.IS_DURATION_VARIABLE}
                 */
